...
SELECT * FROM country WHERE indepyear > 1950 AND GovernmentForm LIKE 'Constitutional Monarchy';
# 14. Listar todos los datos de los diez países europeos de mayor PBN. (Se esperan 15 columnas y 10 registros).
SELECT * FROM country WHERE Continent LIKE 'Europe' ORDER By GNP DESC LIMIT 10;
...
SELECT * FROM city WHERE CountryCode LIKE (SELECT code FROM country WHERE Name = 'Argentina') AND District <>'Buenos Aires';
